...
function CardFeito (){
    ...
    function apareceForm(){
        document.getElementsByClassName('butForm')[3].addEventListener("click", (event) => {
            // highlight the mouseover target
            let form = document.getElementsByClassName('formArea')
            form[3].style.visibility = "visible";
            form[3].style.transition = "all 0.6s";
        });
    }

    function escondeForm(){
        document.getElementsByClassName('botaoCinza')[3].addEventListener("click", (event) => {
            // highlight the mouseover target
            let form = document.getElementsByClassName('formArea')
            form[3].style.visibility = "hidden";
            form[3].style.transition = "all 0.2s";
        });
    }
