...
function CardAFazer (){
    ...
    function apareceForm(){
        document.getElementsByClassName('butForm')[1].addEventListener("click", (event) => {
            // highlight the mouseover target
            let form = document.getElementsByClassName('formArea')
            form[1].style.visibility = "visible";
            form[1].style.transition = "all 0.6s";
        });
    }

    function escondeForm(){
        document.getElementsByClassName('botaoCinza')[1].addEventListener("click", (event) => {
            // highlight the mouseover target
            let form = document.getElementsByClassName('formArea')
            form[1].style.visibility = "hidden";
            form[1].style.transition = "all 0.2s";
        });
    }
